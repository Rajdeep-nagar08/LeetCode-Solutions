...
if word 
'xyz' forms initially at level 3, than there will be no sence to form it again at level >3 , so remove it from dict list or 'st' after completion of level 3

so that we will not form it on other levels except 3
